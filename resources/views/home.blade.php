          ...
          <div class="col-md-6 col-lg-5 offset-lg-3 admin-bar hidden-sm-down">
            <nav class="nav nav-inline"> 
              ...
              <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">  
                ...
                <img class="img-fluid img-circle" src="img/admin-bg.jpg"></a> 
                <b class="caret"></b></a>
...
<nav class="navbar top-nav">
    ...
    <div class="collapse navbar-toggleable-md" id="exCollapsingNavbar2"> <a class="navbar-brand" href="#">Responsive navbar</a>
        ...
        <li class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Japanese Culture <b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="nippi/japanese_culture/food.html">Food</a></li>
                <li><a href="japanese_culture/etiquette.html">Etiquette</a></li>
                <li><a href="japanese_culture/tradition.html">Tradition</a></li>
                <li><a href="japanese_culture/language.html">Language</a></li>
                <li><a href="japanese_culture/pop_culture.html">Pop Culture</a></li>
                <li><a href="japanese_culture/arts_and_crafts.html">Arts &amp; Crafts </a></li>
              </ul>
            </li>
...
<footer>
    ...
    <div class="row">
        ...
        <h6 class="heading-footer">About NIPPI.COM</h6>
        <p>As humans, we are all bound to experience "Culture shock" and it will surely take some time to get used to our new environment. 
        Learning to accept "Japanese society and culture" into your daily life can be a rich and rewarding experience, 
        but at the same time it can also be challenging. Considering the fact that you have to adjust in unfamiliar surroundings and adapt to 
        Japan’s social and cultural environment is not as easy as it may seem. Either permanently or temporarily – you need to immerse yourself in 
        the local culture and let go of stereotypes and false impressions.</p>
        <p>Nippi.com is well aware of the challenges you face, that’s why this is a great place to gather information about life in Japan and 
        even entertainment to help you ease the process of making the transition from living like an expat to a more Japanese life-style.</p>
        <p><span>Get In Touch With Us</span></p>
        <p><i class="fa fa-envelope"></i> <span>Send us an Email :</span> info@webenlance.com</p>
      </div>
